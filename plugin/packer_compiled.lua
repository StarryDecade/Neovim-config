...
_G.packer_plugins = {
  ...
  ["bufferline.nvim"] = {
    loaded = true,
    path = "/home/starrydecade/.local/share/nvim/site/pack/packer/start/bufferline.nvim",
  ...
  ["toggleterm.nvim"] = {
    ...
    loaded = true,
    path = "/home/starrydecade/.local/share/nvim/site/pack/packer/start/toggleterm.nvim",
